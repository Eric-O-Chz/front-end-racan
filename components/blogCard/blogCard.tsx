...
const BlogCard: React.FC<ProductCardProps> = ({ imageUrl, altText, name, blog, isNew }) => {
  return (
    <div className=" group relative flex-shrink-0 w-64 sm:w-72 cursor-pointer border-b-3 border-rose-500">
      ...
      */}
      ...
      <div className="mt-5 text-left ">
        ...
        <p className="mt-1 text-sm text-gray-900 mb-5 font-blog"> {blog}</p>
      </div>
